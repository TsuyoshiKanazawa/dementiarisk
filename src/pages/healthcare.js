        ...
        <div id="about" className={style.about}>
          ...
          <div className={style.aboutCopyContainer}>
            ...
            <div className={style.aboutCopy}>
              <div className={style.mask}>
                <h1 id="aboutTitle">SupportBrainとは？</h1>
              </div>
            ...
            <div className={style.aboutCopySp}>
              <h1 id="aboutTitleSp">SupportBrainとは？</h1>
              <h2 id="aboutCopySp">MRI装置で<br />撮像された脳画像を用いて、<br />脳全体の状態から<br />将来の認知症リスクを<br />予測する。</h2>
            </div>

            <div className={style.aboutText}>
              <div className={style.mask}>
                <h3 id="aboutText">SupportBrainは、島根大学医学部、滋賀医科大学、株式会社ERISAで共同開発された脳画像解析技術で、脳の状態を検査し将来の認知症リスクを予測します。<small>（1）</small>脳の一部だけではなく、脳全体を膨大なデータと比較することで、高い精度を実現。将来を見据えた認知症予防に取り組むきっかけを提供し、受検者のライフスタイル見直しに貢献します。</h3>
              </div>
            </div>
          </div>
