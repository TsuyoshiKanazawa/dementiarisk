        ...
        <Layout>
            ...
            <body id="body" className={style.body}>
                ...
                <div className={style.contactCompletion}>
                    <StaticImage src="../images/contactCompletionBack.png" alt=" profile" quality={90} placeholder="none" formats={["AUTO", "WEBP", "AVIF"]} className={style.contactCompletionBack} />
                        ...
                        <div className={style.listFooter}>
                            <div className={style.listStyle}>
                                <div className={style.list}>
                                    <hr /><a href="/#about"><p>認知症リスク検査とは？</p></a>
                                </div>
                                <div className={style.list}>
